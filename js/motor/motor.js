...
export class Motor {
  constructor(canvas) {
    ...
    const seed = Date.now(); // semilla por mundo (cambia cada carga). Para reproducir, pasar desde UI.
    this.mundo = new Mundo(seed); this.jugador = new Jugador(); this.inventario = new Inventario();
